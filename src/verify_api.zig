...
pub fn allocate(len: u32) Result {
...
pub fn free(pointer: [*]u8, len: u32) void {
...
pub fn signatureDecode(str: [*]const u8, len: u32) Result {
    const sig = struct {
...
/// On success, returns the number of bytes used. On failure, returns 0.
pub fn publicKeyDecodeFromBase64(str: [*]const u8, len: u32) Result {
    const pk = struct {
...
pub fn verifierUpdate(verifier: *Verifier, bytes: [*]const u8, length: u32) void {
...
pub fn verifierVerify(verifier: *Verifier) Result {
...
pub fn verifierDeinit(verifier: *Verifier) void {
